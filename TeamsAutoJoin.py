...
def login(driver):
    ...
    while (True):
        ...
        newButton.click()
        try:
            WebDriverWait(driver, 5).until(expected_conditions.invisibility_of_element(
...
def launchHeadlessClass():
    ...
    driver.get(
        "https://teams.microsoft.com/_#/school/conversations/General?threadId=19:6bcff50be57a4de59f0d29ce06258c49@thread.tacv2&ctx=channel")
    time.sleep(100)
    driver.quit()
...
def hello():
    messagebox.showinfo("Launch Class", "Press Ok to Launch Class")
    launchHeadlessClass()


B1 = Button(top, text="Launch Class", command=hello)
B1.place(x=60, y=50)
